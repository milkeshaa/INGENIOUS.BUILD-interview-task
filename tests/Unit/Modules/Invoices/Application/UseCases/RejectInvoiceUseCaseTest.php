...
/** @coversDefaultClass \App\Modules\Invoices\Application\UseCases\RejectInvoice */
class RejectInvoiceUseCaseTest extends TestCase
{
    private RejectInvoice $useCase;

    public function setUp(): void
    {
        parent::setUp();

        $this->useCase = new RejectInvoice(approvalFacade: new ApprovalFacade(dispatcher: Event::fake()));
    }

    /**
     * @dataProvider data
     */
    public function test_execute_reject_invoice_use_case(callable $createInvoice, array $result)
    {
        if (!$result['is_valid']) {
