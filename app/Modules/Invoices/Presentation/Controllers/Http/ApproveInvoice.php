...
use App\Modules\Invoices\Application\UseCases\ApproveInvoice as ApproveInvoiceUseCase;
...
class ApproveInvoice extends Controller
{
    public function __construct(
        private readonly InvoiceRepositoryInterface $repository,
        private readonly ApproveInvoiceUseCase $useCase,
    ) {}
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        try {
            ...
            return new JsonResponse(data: ['message' => 'Something wrong happened'], status: JsonResponse::HTTP_BAD_REQUEST);
        }
    }
